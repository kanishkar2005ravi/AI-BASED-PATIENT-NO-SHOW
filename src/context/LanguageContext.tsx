...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'patients.no_found': 'No Patients Found',
    'patients.search_placeholder': 'Search patients by name, ID, or phone...',
    'patients.col_id': 'Patient ID',
    'patients.col_name': 'Name & Email',
    'patients.col_phone': 'Phone',
    'patients.col_attended': 'Attended Visits',
    'patients.col_missed': 'Not Attended (No-Show)',
    'patients.col_risk': 'AI Risk Level',
    'patients.col_actions': 'Actions',

    // Doctors Page Keys
    'doctors.title': 'Hospital Doctor Management',
    'doctors.directory': 'Doctor Directory & Schedules',
    'doctors.add': 'Add New Doctor',
    'doctors.col_id': 'Doctor ID',
    'doctors.col_dept': 'Department',
    'doctors.col_exp': 'Experience',
    'doctors.col_email': 'Email',
    'doctors.availability': 'Availability',
    'doctors.manage_profile': 'Manage Profile',
    'doctors.send_schedule': "Send Today's Schedule (Email/WhatsApp)",
    'doctors.download_csv': 'Download Doctors CSV',

    // Appointments & Waitlist Page Keys
    'appointments.title': 'My Appointments',
    'appointments.admin_title': 'Hospital Appointments & Attendance Management',
    'appointments.select_physician': 'Select Physician to View Risk-Separated Schedule:',
    'appointments.all_doctors': 'All Doctors',
    'appointments.low_risk_patients': 'Low Risk Patients',
    'appointments.med_risk_patients': 'Medium Risk Patients',
    'appointments.high_risk_patients': 'High Risk Patients',
    'appointments.filter_status': 'Filter Status:',
    'appointments.all_statuses': 'All Statuses',
    'appointments.all_risk_levels': 'All AI Risk Levels',
    ...
    'waitlist.admin_title': 'Automated Waitlist Recovery System',
    'waitlist.active_queue': 'Active Waitlist Queue',
    ...
    'waitlist.refresh': 'Refresh Queue',
    'waitlist.pos': 'Queue Pos',
    'waitlist.target_date': 'Target Date',
    'waitlist.preferred_slot': 'Preferred Slot',
    'waitlist.status': 'Auto-Recovery Status',

    'analytics.title': 'Hospital Analytics & Reports',
    'analytics.doctors_directory': 'Hospital Doctors Directory',
    'analytics.download_csv': 'Download',
    'analytics.low_risk_csv': 'Low Risk CSV',
    'analytics.medium_risk_csv': 'Medium Risk CSV',
    'analytics.high_risk_csv': 'High Risk CSV',
    ...
    'metric.total_patients': 'Total Patients',
    'metric.total_appointments': 'Total Appointments',
    'metric.total_cancelled': 'Total Cancelled',
    'metric.total_rescheduled': 'Total Rescheduled',
    'metric.active_doctors': 'Active Doctors',
    'metric.todays_appointments': "Today's Appointments",
    'metric.todays_cancelled': "Today's Cancelled",
    'metric.todays_rescheduled': "Today's Rescheduled",
    'metric.todays_missed': "Today's Missed",
    'metric.yesterdays_appointments': "Yesterday's Appointments",
    'metric.yesterdays_cancelled': "Yesterday's Cancelled",
    'metric.yesterdays_rescheduled': "Yesterday's Rescheduled",
    'metric.yesterdays_missed': "Yesterday's Missed",
    'metric.custom_appointments': "Selected Date Appointments",
    'metric.custom_cancelled': "Selected Date Cancelled",
    'metric.custom_rescheduled': "Selected Date Rescheduled",
    'metric.custom_missed': "Selected Date Missed",
    'metric.7days_appointments': "7 Days Appointments",
    'metric.7days_cancelled': "7 Days Cancelled",
    'metric.7days_rescheduled': "7 Days Rescheduled",
    'metric.7days_missed': "7 Days Missed",
    'metric.30days_appointments': "30 Days Appointments",
    'metric.30days_cancelled': "30 Days Cancelled",
    'metric.30days_rescheduled': "30 Days Rescheduled",
    'metric.30days_missed': "30 Days Missed",
    'metric.waitlist': 'Waitlist',
    'metric.accepted_waitlist': 'Accepted Waitlist',
    'metric.urgent_requests': 'Urgent Emergency Requests',
    ...
    'metric.total_missed': 'Total Missed',
  ...
  ta: {
    ...
    // Patients Page Keys
    'patients.title': 'நோயாளிகள் அடைவு',
    'patients.total': 'மொத்த நோயாளிகள்',
    'patients.create': 'புதிய நோயாளி கணக்கு உருவாக்கவும்',
    'patients.no_found': 'நோயாளிகள் எவரும் காணப்படவில்லை',
    'patients.search_placeholder': 'பெயர், ஐடி அல்லது தொலைபேசி மூலம் தேடுக...',
    'patients.col_id': 'நோயாளி ஐடி',
    'patients.col_name': 'பெயர் & மின்னஞ்சல்',
    'patients.col_phone': 'தொலைபேசி',
    'patients.col_attended': 'வருகை புரிந்தவை',
    'patients.col_missed': 'வருகை தராதவை',
    'patients.col_risk': 'AI அபாய நிலை',
    'patients.col_actions': 'செயல்கள்',

    // Doctors Page Keys
    'doctors.title': 'மருத்துவமனை மருத்துவர் நிர்வாகம்',
    'doctors.directory': 'மருத்துவர் அடைவு & நேர அட்டவணை',
    'doctors.add': 'புதிய மருத்துவரை சேர்க்க',
    'doctors.col_id': 'மருத்துவர் ஐடி',
    'doctors.col_dept': 'துறை',
    'doctors.col_exp': 'அனுபவம்',
    'doctors.col_email': 'மின்னஞ்சல்',
    'doctors.availability': 'நேரங்கள்',
    'doctors.manage_profile': 'சுயவிவரத்தை நிர்வகிக்க',
    'doctors.send_schedule': 'இன்றைய அட்டவணையை அனுப்புக (Email/WhatsApp)',
    'doctors.download_csv': 'மருத்துவர் பட்டியலை பதிவிறக்குக (CSV)',

    // Appointments & Waitlist Page Keys
    'appointments.title': 'எனது மருத்துவ சந்திப்புகள்',
    'appointments.admin_title': 'மருத்துவமனை சந்திப்புகள் & வருகை நிர்வாகம்',
    'appointments.select_physician': 'மருத்துவரைத் தேர்ந்தெடுக்கவும்:',
    'appointments.all_doctors': 'அனைத்து மருத்துவர்கள்',
    'appointments.low_risk_patients': 'குறைந்த அபாய நோயாளிகள்',
    'appointments.med_risk_patients': 'மிதமான அபாய நோயாளிகள்',
    'appointments.high_risk_patients': 'அதிக அபாய நோயாளிகள்',
    'appointments.filter_status': 'நிலை வடிகட்டி:',
    'appointments.all_statuses': 'அனைத்து நிலைகளும்',
    'appointments.all_risk_levels': 'அனைத்து AI அபாய நிலைகளும்',
    ...
    'waitlist.admin_title': 'தானியங்கி காத்திருப்புப் பட்டியல் மீட்பு அமைப்பு',
    'waitlist.active_queue': 'செயலில் உள்ள காத்திருப்பு வரிசை',
    ...
    'waitlist.refresh': 'வரிசையைப் புதுப்பிக்கவும்',
    'waitlist.pos': 'வரிசை எண்',
    'waitlist.target_date': 'இலக்கு தேதி',
    'waitlist.preferred_slot': 'விருப்பமான நேரம்',
    'waitlist.status': 'தானியங்கி மீட்பு நிலை',

    'analytics.title': 'மருத்துவமனை பகுப்பாய்வு & அறிக்கைகள்',
    'analytics.doctors_directory': 'மருத்துவமனை மருத்துவர்கள் அடைவு',
    'analytics.download_csv': 'பதிவிறக்குக',
    'analytics.low_risk_csv': 'குறைந்த அபாய CSV',
    'analytics.medium_risk_csv': 'மிதமான அபாய CSV',
    'analytics.high_risk_csv': 'அதிக அபாய CSV',
    ...
    // Metric Cards & Dashboard Extra
    'metric.total_patients': 'மொத்த நோயாளிகள்',
    'metric.total_appointments': 'மொத்த சந்திப்புகள்',
    'metric.total_cancelled': 'மொத்த ரத்து செய்யப்பட்டது',
    'metric.total_rescheduled': 'மொத்த மறுதேதியிடப்பட்டது',
    'metric.active_doctors': 'செயலில் உள்ள மருத்துவர்கள்',
    'metric.todays_appointments': 'இன்றைய சந்திப்புகள்',
    'metric.todays_cancelled': 'இன்றைய ரத்து செய்யப்பட்டது',
    'metric.todays_rescheduled': 'இன்றைய மறுதேதியிடப்பட்டது',
    'metric.todays_missed': 'இன்றைய தவறியவை',
    'metric.yesterdays_appointments': 'நேற்றைய சந்திப்புகள்',
    'metric.yesterdays_cancelled': 'நேற்றைய ரத்து செய்யப்பட்டது',
    'metric.yesterdays_rescheduled': 'நேற்றைய மறுதேதியிடப்பட்டது',
    'metric.yesterdays_missed': 'நேற்றைய தவறியவை',
    'metric.custom_appointments': 'தேர்ந்தெடுக்கப்பட்ட தேதி சந்திப்புகள்',
    'metric.custom_cancelled': 'தேர்ந்தெடுக்கப்பட்ட தேதி ரத்து',
    'metric.custom_rescheduled': 'தேர்ந்தெடுக்கப்பட்ட தேதி மாற்றம்',
    'metric.custom_missed': 'தேர்ந்தெடுக்கப்பட்ட தேதி தவறியவை',
    'metric.7days_appointments': '7 நாட்கள் சந்திப்புகள்',
    'metric.7days_cancelled': '7 நாட்கள் ரத்து',
    'metric.7days_rescheduled': '7 நாட்கள் மாற்றம்',
    'metric.7days_missed': '7 நாட்கள் தவறியவை',
    'metric.30days_appointments': '30 நாட்கள் சந்திப்புகள்',
    'metric.30days_cancelled': '30 நாட்கள் ரத்து',
    'metric.30days_rescheduled': '30 நாட்கள் மாற்றம்',
    'metric.30days_missed': '30 நாட்கள் தவறியவை',
    'metric.waitlist': 'காத்திருப்போர் பட்டியல்',
    'metric.accepted_waitlist': 'ஏற்கப்பட்ட காத்திருப்போர்',
    'metric.urgent_requests': 'உடனடி அவசர சிகிச்சை கோரிக்கைகள்',
    ...
    'metric.total_missed': 'மொத்த தவறவிட்டவை',
