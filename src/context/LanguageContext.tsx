...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'dashboard.daily_hospital_ops': 'Daily Hospital Operations & Patient Attendance',
    'dashboard.realtime_schedules_sub': 'Real-time daily physician schedules, consultation outcomes & emergency waitlist tracking',
    'dashboard.today': 'Today',
    'dashboard.yesterday': 'Yesterday',
    'dashboard.selected_date': 'Selected Date',
    'dashboard.todays': "Today's",
    'dashboard.yesterdays': "Yesterday's",
    'dashboard.selected_dates': 'Selected Date',
    'dashboard.fetching_metrics': 'Fetching hospital metrics & AI predictions...',
    'dashboard.patient_list': 'Patient List',
    'dashboard.patient_count': 'Patient(s)',
    'dashboard.patient_list_sub': 'Detailed patient records, appointment slots, assigned doctors, and AI risk evaluations',
    'dashboard.close': 'Close',
    'dashboard.close_patient_list': 'Close patient list',
    'dashboard.assigned_specialist': 'Assigned Specialist',
    'dashboard.general_practice': 'General Practice',
    'dashboard.ai_risk_breakdown': 'AI Predictive No-Show Risk Breakdown',
    'dashboard.distribution_volume': 'Distribution Volume',
    ...
    'dashboard.patient_breakdown': 'Patient Breakdown',
    'dashboard.risk_patient_sub': 'Detailed AI predictions, risk scores, and clinical factors for {level} risk patients',
    'dashboard.click_view_apts_list': 'Click down arrow to view appointments patient list',
    'dashboard.click_view_attended_list': 'Click down arrow to view attended patient list',
    'dashboard.click_view_cancelled_list': 'Click down arrow to view cancelled patient list',
    'dashboard.click_view_rescheduled_list': 'Click down arrow to view rescheduled patient list',
    'dashboard.click_view_waitlist_list': 'Click down arrow to view waitlist patient list',
    'dashboard.click_view_accepted_list': 'Click down arrow to view accepted waitlist patient list',
    'dashboard.click_view_missed_list': 'Click down arrow to view missed patient list',
    'dashboard.click_view_low_risk_list': 'Click down arrow to view Low Risk patient list',
    'dashboard.click_view_med_risk_list': 'Click down arrow to view Medium Risk patient list',
    'dashboard.click_view_high_risk_list': 'Click down arrow to view High Risk patient list',
    
    // Metric labels
    'metric.attended_visits': 'Attended Visits',
    'metric.cancelled_slots': 'Cancelled Slots',
    'metric.rescheduled_slots': 'Rescheduled Slots',
    'metric.emergency_waitlist': 'Emergency Waitlist',
    'metric.noshow_absences': 'No-Show Absences',
    'metric.todays_attended': "Today's Attended",
    'metric.yesterdays_attended': "Yesterday's Attended",
    'metric.custom_attended': "Selected Date Attended",
    'metric.todays_low_risk': "Today's Low Risk",
    'metric.todays_medium_risk': "Today's Medium Risk",
    'metric.todays_high_risk': "Today's High Risk",
    'metric.yesterdays_low_risk': "Yesterday's Low Risk",
    'metric.yesterdays_medium_risk': "Yesterday's Medium Risk",
    'metric.yesterdays_high_risk': "Yesterday's High Risk",
    'metric.custom_low_risk': "Selected Date Low Risk",
    'metric.custom_medium_risk': "Selected Date Medium Risk",
    'metric.custom_high_risk': "Selected Date High Risk",

    // Table Headers
    'table.appointment_id': 'Appointment ID',
    'table.patient_name': 'Patient Name',
    'table.physician_dept': 'Physician & Department',
    'table.time_date': 'Time & Date',
    'table.ai_risk': 'AI Risk Assessment',
    'table.status': 'Status',
    'table.doctor': 'Doctor',
    ...
    'table.email': 'Email',
    'table.auto_recovery_status': 'Auto-Recovery Status',
    'table.active': 'Active',
    'table.download': 'Download',
    'table.download_csv': 'Download CSV',
    'table.low_risk_csv': 'Low Risk CSV',
    'table.medium_risk_csv': 'Medium Risk CSV',
    'table.high_risk_csv': 'High Risk CSV'
  },
  ta: {
    // Header & Navigation
    ...
    // Dashboard Specific Keys
    'dashboard.daily_hospital_ops': 'தினசரி மருத்துவமனை செயல்பாடுகள் & நோயாளி வருகை',
    'dashboard.realtime_schedules_sub': 'நேரலை மருத்துவர் அட்டவணைகள், ஆலோசனை முடிவுகள் & அவசர காத்திருப்பு கண்காணிப்பு',
    'dashboard.today': 'இன்று',
    'dashboard.yesterday': 'நேற்று',
    'dashboard.selected_date': 'தேர்ந்தெடுக்கப்பட்ட தேதி',
    'dashboard.todays': 'இன்றைய',
    'dashboard.yesterdays': 'நேற்றைய',
    'dashboard.selected_dates': 'தேர்ந்தெடுக்கப்பட்ட தேதி',
    'dashboard.fetching_metrics': 'மருத்துவமனை புள்ளிவிவரங்கள் & AI கணிப்புகளை ஏற்றுகிறது...',
    'dashboard.patient_list': 'நோயாளி பட்டியல்',
    'dashboard.patient_count': 'நோயாளி(கள்)',
    'dashboard.patient_list_sub': 'விரிவான நோயாளி பதிவுகள், சந்திப்பு நேரங்கள், நியமிக்கப்பட்ட மருத்துவர்கள் மற்றும் AI ஆபத்து மதிப்பீடுகள்',
    'dashboard.close': 'மூடு',
    'dashboard.close_patient_list': 'நோயாளி பட்டியலை மூடு',
    'dashboard.assigned_specialist': 'நியமிக்கப்பட்ட நிபுணர்',
    'dashboard.general_practice': 'பொது மருத்துவம்',
    'dashboard.ai_risk_breakdown': 'AI கணிக்கப்பட்ட வராத ஆபத்து பிரிவு',
    'dashboard.distribution_volume': 'பகிர்வு அளவு',
    'dashboard.action_label': 'நடவடிக்கை',
    'dashboard.email': 'மின்னஞ்சல்',
    'dashboard.whatsapp': 'வாட்ஸ்அப்',
    'dashboard.low_risk': 'குறைந்த ஆபத்து',
    'dashboard.medium_risk': 'நடுத்தர ஆபத்து',
    'dashboard.high_risk': 'அதிக ஆபத்து',
    'dashboard.patient_breakdown': 'நோயாளி விவரங்கள்',
    'dashboard.risk_patient_sub': '{level} ஆபத்து நோயாளிகளுக்கான விரிவான AI கணிப்புகள், ஆபத்து மதிப்பெண்கள் மற்றும் மருத்துவ காரணிகள்',
    'dashboard.click_view_apts_list': 'சந்திப்பு நோயாளி பட்டியலைக் காண கீழ் அம்புக்குறியை அழுத்தவும்',
    'dashboard.click_view_attended_list': 'வருகை புரிந்த நோயாளி பட்டியலைக் காண கீழ் அம்புக்குறியை அழுத்தவும்',
    'dashboard.click_view_cancelled_list': 'ரத்து செய்யப்பட்ட நோயாளி பட்டியலைக் காண கீழ் அம்புக்குறியை அழுத்தவும்',
    'dashboard.click_view_rescheduled_list': 'மாற்றப்பட்ட நோயாளி பட்டியலைக் காண கீழ் அம்புக்குறியை அழுத்தவும்',
    'dashboard.click_view_waitlist_list': 'காத்திருப்பு நோயாளி பட்டியலைக் காண கீழ் அம்புக்குறியை அழுத்தவும்',
    'dashboard.click_view_accepted_list': 'ஏற்கப்பட்ட காத்திருப்பு நோயாளி பட்டியலைக் காண கீழ் அம்புக்குறியை அழுத்தவும்',
    'dashboard.click_view_missed_list': 'தவறிய நோயாளி பட்டியலைக் காண கீழ் அம்புக்குறியை அழுத்தவும்',
    'dashboard.click_view_low_risk_list': 'குறைந்த ஆபத்து நோயாளி பட்டியலைக் காண கீழ் அம்புக்குறியை அழுத்தவும்',
    'dashboard.click_view_med_risk_list': 'நடுத்தர ஆபத்து நோயாளி பட்டியலைக் காண கீழ் அம்புக்குறியை அழுத்தவும்',
    'dashboard.click_view_high_risk_list': 'அதிக ஆபத்து நோயாளி பட்டியலைக் காண கீழ் அம்புக்குறியை அழுத்தவும்',
    
    // Metric labels
    'metric.attended_visits': 'வருகை புரிந்தவை',
    'metric.cancelled_slots': 'ரத்து செய்யப்பட்டவை',
    'metric.rescheduled_slots': 'மாற்றப்பட்டவை',
    'metric.emergency_waitlist': 'அவசர காத்திருப்பு',
    'metric.noshow_absences': 'வராத வருகைகள்',
    'metric.todays_attended': 'இன்றைய வருகை',
    'metric.yesterdays_attended': 'நேற்றைய வருகை',
    'metric.custom_attended': 'தேர்ந்தெடுக்கப்பட்ட தேதி வருகை',
    'metric.todays_low_risk': 'இன்றைய குறைந்த ஆபத்து',
    'metric.todays_medium_risk': 'இன்றைய நடுத்தர ஆபத்து',
    'metric.todays_high_risk': 'இன்றைய அதிக ஆபத்து',
    'metric.yesterdays_low_risk': 'நேற்றைய குறைந்த ஆபத்து',
    'metric.yesterdays_medium_risk': 'நேற்றைய நடுத்தர ஆபத்து',
    'metric.yesterdays_high_risk': 'நேற்றைய அதிக ஆபத்து',
    'metric.custom_low_risk': 'தேர்ந்தெடுக்கப்பட்ட தேதி குறைந்த ஆபத்து',
    'metric.custom_medium_risk': 'தேர்ந்தெடுக்கப்பட்ட தேதி நடுத்தர ஆபத்து',
    'metric.custom_high_risk': 'தேர்ந்தெடுக்கப்பட்ட தேதி அதிக ஆபத்து',

    // Table Headers
    'table.appointment_id': 'சந்திப்பு ஐடி',
    'table.patient_name': 'நோயாளி பெயர்',
    'table.physician_dept': 'மருத்துவர் & துறை',
    'table.time_date': 'நேரம் & தேதி',
    'table.ai_risk': 'AI ஆபத்து மதிப்பீடு',
    'table.status': 'நிலை',
    'table.doctor': 'மருத்துவர்',
    'table.specialization': 'சிறப்புத் துறை',
    'table.department': 'துறை',
    'table.experience': 'அனுபவம்',
    'table.email': 'மின்னஞ்சல்',
    'table.auto_recovery_status': 'தானியங்கி மீட்பு நிலை',
    'table.active': 'செயலில் உள்ளது',
    'table.download': 'பதிவிறக்கு',
    'table.download_csv': 'CSV பதிவிறக்கு',
    'table.low_risk_csv': 'குறைந்த ஆபத்து CSV',
    'table.medium_risk_csv': 'நடுத்தர ஆபத்து CSV',
    'table.high_risk_csv': 'அதிக ஆபத்து CSV'
  }
