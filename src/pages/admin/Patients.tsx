...
import { UserPlus, Search, Eye, Edit, UserX, UserCheck, ShieldAlert } from 'lucide-react';
            ...
            <table className="w-full text-left text-sm border-collapse">
              <thead>
                <tr className="border-b border-slate-200 text-xs font-bold text-slate-500 uppercase tracking-wider bg-slate-50/50">
                  ...
                  <th className="py-3 px-4">No-Show Rate</th>
              ...
              <tbody className="divide-y divide-slate-100">
                {filteredPatients.map(pat => (
                  <tr key={pat.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="py-3.5 px-4 text-slate-600">{pat.email}</td>
                    ...
                    <td className="py-3.5 px-4 font-semibold text-slate-700">
                      {pat.totalAppointments} visits ({pat.attendedAppointments} attended)
                    </td>
                    <td className="py-3.5 px-4">
                      <span
